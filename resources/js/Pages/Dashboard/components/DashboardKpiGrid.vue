...
<template>
    ...
    >
        <article
            v-for="kpi in kpis"
            :key="kpi.label"
            class="relative flex flex-col justify-between overflow-hidden rounded-lg bg-surface-container-lowest p-space-lg shadow-sm"
        >
            <div
            ...
            <div class="my-space-xs">
                ...
                >
                    ...
                    >
                        <div
                            class="h-1.5 rounded-full bg-primary-container"
