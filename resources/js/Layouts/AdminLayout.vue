...
const navigation = [
    ...
    {
        name: "Visit Exceptions",
        href: "/visit_exception",
...
<template>
    <div class="min-h-screen bg-[#F8FAFC] font-sans flex text-slate-800">
        ...
        >
            ...
            <div
                v-if="isSidebarOpen"
                class="p-4 border-t border-white/10 text-xs text-slate-300 bg-[#163866]/50"
            >
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            >
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div
                        class="hidden sm:flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-medium"
                    >
                        <span
